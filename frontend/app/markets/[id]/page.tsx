      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            {/* Trading Card - Desktop Only */}
            <motion.div 
              initial={{ y: 50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="hidden lg:block bg-white rounded-2xl p-4 sm:p-6 shadow-xl border border-gray-100 sticky top-8"
            >
              <TradingCard marketId={parseInt(marketId)} question={market.question as string} />
            </motion.div>
